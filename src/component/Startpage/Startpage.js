        ...
        <div className=" h-screen absolute top-0 pt-16 lg:pt-5 max-h-max flex gap-5 flex-col lg:flex-row items-center justify-center w-full p-2 z-[-10000]">
            ...
            <div className="w-full">
                <div className="text-center lg:text-left">
                    ...
                    <p className=" lg:w-10/12 w-11/12 text-justify m-auto lg:m-0 text-sm font-normal text-gray-400 p-1 pb-3">Thanku is a problem sharing website where you can share your problem and get solution in the form of suggestion.With can travel to defferent places to refresh your mind.ou can get various legal benefits here if you want and also listen to different types of mind blowing songs to make your mind happy.With this you can chat live with any other person.</p>
